  ...
  return (
    <div className="mx-auto max-w-[1400px] p-6 lg:p-8">
      ...
      <div className="mb-6 flex items-center gap-2 text-sm text-gray-500">
        <Link href={`/contracts/${params.id}`} className="flex items-center gap-1.5 hover:text-gray-700 transition-colors">
      ...
      <div className="mb-6">
        ...
        <p className="mt-1 text-sm text-gray-500">{contract.contractNumber} · Update contract details</p>
      </div>
          ...
          <Card>
            ...
            <CardBody>
              <textarea
                ...
                rows={32}
                className="w-full rounded-lg border border-gray-200 bg-white px-4 py-3 font-mono text-[13px] leading-7 text-gray-800 focus:border-orange-500 focus:outline-none focus:ring-2 focus:ring-orange-500/20 transition-colors resize-none"
