...
export default function Button({
  ...
  const variantStyles = {
    ...
    secondary: `bg-gray-100 text-gray-900 hover:bg-gray-200 hover:shadow-md hover:-translate-y-0.5 focus-visible:ring-gray-400 active:translate-y-0 disabled:bg-gray-50 disabled:shadow-none disabled:translate-y-0`,
    outline: `bg-white border-2 border-gray-300 text-gray-700 hover:bg-gray-50 hover:border-gray-400 hover:shadow-md hover:-translate-y-0.5 focus-visible:ring-gray-400 active:translate-y-0 disabled:bg-gray-50 disabled:text-gray-400 disabled:border-gray-200 disabled:shadow-none disabled:translate-y`,
    danger: `
    bg-red-600
    text-white
    shadow-sm
